...
: epos_handle_(epos_handle)
{
  ...
  param_name.str("");
  param_name << "joint_" << num << "/sensor_range_min";
  if(!nh.getParam(param_name.str(), sensor_range_min_))
    throw runtime_error("JointController: missing ROS parameter for joint_X/sensor_range_min");

  param_name.str("");
  param_name << "joint_" << num << "/sensor_range_max";
  if(!nh.getParam(param_name.str(), sensor_range_max_))
    throw runtime_error("JointController: missing ROS parameter for joint_X/sensor_range_min");
