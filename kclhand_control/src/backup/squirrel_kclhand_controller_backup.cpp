...
bool  motorRotationToConfiguration(unsigned short motorTotalNumber, std::vector<float> configurationData[], sensor_msgs::JointState test_send);
...
std::vector<float> lower_sphere_parallel_grasp_angle;
std::vector<float> lower_sphere_cylindrical_grasp_angle;
std::vector<float> lower_sphere_central_grasp_angle;
std::vector<float> upper_sphere_parallel_grasp_angle;
std::vector<float> upper_sphere_cylindrical_grasp_angle;
std::vector<float> upper_sphere_central_grasp_angle;
...
int main(int argc, char** argv)
{
	...
	ros::NodeHandle n;
//	int palm_motor1, palm_motor2, finger_motor3, finger_motor4, finger_motor5; 
	
	n.getParam("motor_direction", motor_direction);
	
	n.getParam("lower_sphere_parallel_grasp", lower_sphere_parallel_grasp_angle);
	n.getParam("lower_sphere_cylindrical_grasp", lower_sphere_cylindrical_grasp_angle);
	n.getParam("lower_sphere_central_grasp", lower_sphere_central_grasp_angle);
	n.getParam("upper_sphere_parallel_grasp", upper_sphere_parallel_grasp_angle);
	n.getParam("upper_sphere_cylindrical_grasp", upper_sphere_cylindrical_grasp_angle);
	n.getParam("upper_sphere_central_grasp", upper_sphere_central_grasp_angle);
